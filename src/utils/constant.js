const Constant = {
    ...
    OAUTH_ACCESS_TOKEN_ENDPOINT: "http://tguc-uat.private.test.skeps.dev:8086/oauth/lender/server/token",
    ...
    APPLICANT_ORDER_DETAILS_URL: "http://tguc-uat.private.test.skeps.dev:3031/reader/public/application/status",
    ...
    SEND_EMAIL_URL: "http://tguc-uat.private.test.skeps.dev:3041/external/send-email",
